...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Exp_Direct_Comm.agency'
        db.delete_column('lobbyingph_exp_direct_comm', 'agency_id')

        # Adding M2M table for field agencies on 'Exp_Direct_Comm'
        db.create_table('lobbyingph_exp_direct_comm_agencies', (
        ...
        db.create_unique('lobbyingph_exp_direct_comm_agencies', ['exp_direct_comm_id', 'agency_id'])


    def backwards(self, orm):
        # Adding field 'Exp_Direct_Comm.agency'
        db.add_column('lobbyingph_exp_direct_comm', 'agency',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lobbyingph.Agency'], null=True, blank=True),
                      keep_default=False)

        # Removing M2M table for field agencies on 'Exp_Direct_Comm'
        db.delete_table('lobbyingph_exp_direct_comm_agencies')
