...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('lobbyingph_issue_articles', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('issue', models.ForeignKey(orm['lobbyingph.issue'], null=False)),
            ('article', models.ForeignKey(orm['lobbyingph.article'], null=False))
        ))
        db.create_unique('lobbyingph_issue_articles', ['issue_id', 'article_id'])

        # Removing M2M table for field article on 'Bill'
        db.delete_table('lobbyingph_bill_article')


    def backwards(self, orm):
        # Removing M2M table for field articles on 'Issue'
        db.delete_table('lobbyingph_issue_articles')

        # Adding M2M table for field article on 'Bill'
        db.create_table('lobbyingph_bill_article', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('bill', models.ForeignKey(orm['lobbyingph.bill'], null=False)),
            ('article', models.ForeignKey(orm['lobbyingph.article'], null=False))
        ))
        db.create_unique('lobbyingph_bill_article', ['bill_id', 'article_id'])
    ...
    models = {
        ...
        'lobbyingph.issue': {
            ...
            'articles': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['lobbyingph.Article']", 'null': 'True', 'blank': 'True'}),
            'bill': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lobbyingph.Bill']", 'null': 'True', 'blank': 'True'}),
