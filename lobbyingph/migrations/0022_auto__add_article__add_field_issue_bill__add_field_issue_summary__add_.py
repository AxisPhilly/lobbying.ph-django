...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('lobbyingph_article', (
        ...
        db.send_create_signal('lobbyingph', ['Article'])

        # Adding field 'Issue.bill'
        db.add_column('lobbyingph_issue', 'bill',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lobbyingph.Bill'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Issue.summary'
        db.add_column('lobbyingph_issue', 'summary',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Issue.detail_view'
        db.add_column('lobbyingph_issue', 'detail_view',
    ...
    def backwards(self, orm):
        ...
        db.delete_table('lobbyingph_article')

        # Deleting field 'Issue.bill'
        db.delete_column('lobbyingph_issue', 'bill_id')

        # Deleting field 'Issue.summary'
        db.delete_column('lobbyingph_issue', 'summary')

        # Deleting field 'Issue.detail_view'
        db.delete_column('lobbyingph_issue', 'detail_view')
