...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Lobbyist.terminated'
        db.add_column('lobbyingph_lobbyist', 'terminated',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Lobbyist.termination_quarter'
        db.add_column('lobbyingph_lobbyist', 'termination_quarter',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Firm.terminated'
        db.add_column('lobbyingph_firm', 'terminated',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Firm.termination_quarter'
        db.add_column('lobbyingph_firm', 'termination_quarter',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Principal.terminated'
        db.add_column('lobbyingph_principal', 'terminated',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Principal.termination_quarter'
        db.add_column('lobbyingph_principal', 'termination_quarter',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Lobbyist.terminated'
        db.delete_column('lobbyingph_lobbyist', 'terminated')

        # Deleting field 'Lobbyist.termination_quarter'
        db.delete_column('lobbyingph_lobbyist', 'termination_quarter')

        # Deleting field 'Firm.terminated'
        db.delete_column('lobbyingph_firm', 'terminated')

        # Deleting field 'Firm.termination_quarter'
        db.delete_column('lobbyingph_firm', 'termination_quarter')

        # Deleting field 'Principal.terminated'
        db.delete_column('lobbyingph_principal', 'terminated')

        # Deleting field 'Principal.termination_quarter'
        db.delete_column('lobbyingph_principal', 'termination_quarter')
    ...
    models = {
        ...
        'lobbyingph.article': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 12, 5, 0, 0)'}),
        ...
        'lobbyingph.expenditure': {
            ...
            'methods': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['lobbyingph.Communication_Method']", 'null': 'True', 'blank': 'True'}),
            'officials': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['lobbyingph.Official']", 'null': 'True', 'blank': 'True'}),
            'oldid': ('django.db.models.fields.SmallIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'other_desc': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'position': ('django.db.models.fields.SmallIntegerField', [], {'null': 'True', 'blank': 'True'})
        },
        'lobbyingph.filing': {
        ...
        'lobbyingph.firm': {
            ...
            'termination_quarter': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
