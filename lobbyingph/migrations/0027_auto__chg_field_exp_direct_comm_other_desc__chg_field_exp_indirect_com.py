...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Exp_Direct_Comm.other_desc'
        db.alter_column('lobbyingph_exp_direct_comm', 'other_desc', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Exp_Indirect_Comm.other_desc'
        db.alter_column('lobbyingph_exp_indirect_comm', 'other_desc', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'Exp_Direct_Comm.other_desc'
        db.alter_column('lobbyingph_exp_direct_comm', 'other_desc', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Exp_Indirect_Comm.other_desc'
        db.alter_column('lobbyingph_exp_indirect_comm', 'other_desc', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
