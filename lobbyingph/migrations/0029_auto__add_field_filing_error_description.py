...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Filing.error_description'
        db.add_column('lobbyingph_filing', 'error_description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Filing.error_description'
        db.delete_column('lobbyingph_filing', 'error_description')
