...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Communication_Method'
        db.create_table('lobbyingph_communication_method', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('lobbyingph', ['Communication_Method'])

        # Adding model 'Receipent_Group'
        db.create_table('lobbyingph_receipent_group', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('lobbyingph', ['Receipent_Group'])

        # Adding M2M table for field methods on 'Exp_Indirect_Comm'
        db.create_table('lobbyingph_exp_indirect_comm_methods', (
        ...
        db.create_unique('lobbyingph_exp_indirect_comm_methods', ['exp_indirect_comm_id', 'communication_method_id'])

        # Adding M2M table for field groups on 'Exp_Indirect_Comm'
        db.create_table('lobbyingph_exp_indirect_comm_groups', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('exp_indirect_comm', models.ForeignKey(orm['lobbyingph.exp_indirect_comm'], null=False)),
            ('receipent_group', models.ForeignKey(orm['lobbyingph.receipent_group'], null=False))
        ))
        db.create_unique('lobbyingph_exp_indirect_comm_groups', ['exp_indirect_comm_id', 'receipent_group_id'])


    def backwards(self, orm):
        # Deleting model 'Communication_Method'
        db.delete_table('lobbyingph_communication_method')

        # Deleting model 'Receipent_Group'
        db.delete_table('lobbyingph_receipent_group')

        # Removing M2M table for field methods on 'Exp_Indirect_Comm'
        db.delete_table('lobbyingph_exp_indirect_comm_methods')

        # Removing M2M table for field groups on 'Exp_Indirect_Comm'
        db.delete_table('lobbyingph_exp_indirect_comm_groups')
