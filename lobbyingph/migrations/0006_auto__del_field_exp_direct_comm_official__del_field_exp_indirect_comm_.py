...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Exp_Direct_Comm.official'
        db.delete_column('lobbyingph_exp_direct_comm', 'official_id')

        # Adding M2M table for field officials on 'Exp_Direct_Comm'
        db.create_table('lobbyingph_exp_direct_comm_officials', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('exp_direct_comm', models.ForeignKey(orm['lobbyingph.exp_direct_comm'], null=False)),
            ('official', models.ForeignKey(orm['lobbyingph.official'], null=False))
        ))
        db.create_unique('lobbyingph_exp_direct_comm_officials', ['exp_direct_comm_id', 'official_id'])

        # Deleting field 'Exp_Indirect_Comm.official'
        db.delete_column('lobbyingph_exp_indirect_comm', 'official_id')

        # Adding M2M table for field officials on 'Exp_Indirect_Comm'
        db.create_table('lobbyingph_exp_indirect_comm_officials', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('exp_indirect_comm', models.ForeignKey(orm['lobbyingph.exp_indirect_comm'], null=False)),
            ('official', models.ForeignKey(orm['lobbyingph.official'], null=False))
        ))
        db.create_unique('lobbyingph_exp_indirect_comm_officials', ['exp_indirect_comm_id', 'official_id'])


    def backwards(self, orm):
        # Adding field 'Exp_Direct_Comm.official'
        db.add_column('lobbyingph_exp_direct_comm', 'official',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lobbyingph.Official'], null=True, blank=True),
                      keep_default=False)

        # Removing M2M table for field officials on 'Exp_Direct_Comm'
        db.delete_table('lobbyingph_exp_direct_comm_officials')

        # Adding field 'Exp_Indirect_Comm.official'
        db.add_column('lobbyingph_exp_indirect_comm', 'official',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lobbyingph.Official'], null=True, blank=True),
                      keep_default=False)

        # Removing M2M table for field officials on 'Exp_Indirect_Comm'
        db.delete_table('lobbyingph_exp_indirect_comm_officials')
