...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Bill.number'
        db.alter_column('lobbyingph_bill', 'number', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'Bill.name'
        db.alter_column('lobbyingph_bill', 'name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Bill.number'
        db.alter_column('lobbyingph_bill', 'number', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

        # User chose to not deal with backwards NULL issues for 'Bill.name'
        raise RuntimeError("Cannot reverse this migration. 'Bill.name' and its values cannot be restored.")
