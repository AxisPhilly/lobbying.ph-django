...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Bill.url'
        db.add_column('lobbyingph_bill', 'url',
                      self.gf('django.db.models.fields.URLField')(default='http://legislation.phila.gov/mattersearch/home.aspx', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Bill.url'
        db.delete_column('lobbyingph_bill', 'url')
    ...
    models = {
        ...
        'lobbyingph.bill': {
            ...
            'url': ('django.db.models.fields.URLField', [], {'default': "'http://legislation.phila.gov/mattersearch/home.aspx'", 'max_length': '200'})
        },
        'lobbyingph.category': {
