...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Exp_Direct_Comm.quarter'
        db.delete_column('lobbyingph_exp_direct_comm', 'quarter')


        # Changing field 'Filing.total_exp_indriect_comm'
        db.alter_column('lobbyingph_filing', 'total_exp_indriect_comm', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2))
        ...
        # Deleting field 'Exp_Indirect_Comm.quarter'
        db.delete_column('lobbyingph_exp_indirect_comm', 'quarter')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Exp_Direct_Comm.quarter'
        raise RuntimeError("Cannot reverse this migration. 'Exp_Direct_Comm.quarter' and its values cannot be restored.")

        # Changing field 'Filing.total_exp_indriect_comm'
        db.alter_column('lobbyingph_filing', 'total_exp_indriect_comm', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2))

        # Changing field 'Filing.total_exp_direct_comm'
        db.alter_column('lobbyingph_filing', 'total_exp_direct_comm', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2))

        # Changing field 'Filing.total_exp_other'
        db.alter_column('lobbyingph_filing', 'total_exp_other', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2))

        # User chose to not deal with backwards NULL issues for 'Exp_Indirect_Comm.quarter'
        raise RuntimeError("Cannot reverse this migration. 'Exp_Indirect_Comm.quarter' and its values cannot be restored.")
    ...
    models = {
        ...
        'lobbyingph.filing': {
            ...
            'total_exp_direct_comm': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
            'total_exp_indriect_comm': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
            'total_exp_other': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
