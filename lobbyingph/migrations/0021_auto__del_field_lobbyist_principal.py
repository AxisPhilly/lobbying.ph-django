...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Lobbyist.principal'
    ...
    def backwards(self, orm):
        # Adding field 'Lobbyist.principal'
        db.add_column('lobbyingph_lobbyist', 'principal',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lobbyingph.Principal'], null=True, blank=True),
                      keep_default=False)

        # Removing M2M table for field principal on 'Lobbyist'
        db.delete_table('lobbyingph_lobbyist_principal')
