...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('lobbyingph_article', 'issue',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lobbyingph.Issue'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('lobbyingph_article', 'issue_id')
