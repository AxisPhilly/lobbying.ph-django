...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Filing.source'
        db.delete_column('lobbyingph_filing', 'source')

        # Removing M2M table for field sources on 'Filing'
        db.delete_table('lobbyingph_filing_sources')

        # Adding field 'Source.filing'
        db.add_column('lobbyingph_source', 'filing',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lobbyingph.Filing'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Filing.source'
        db.add_column('lobbyingph_filing', 'source',
        ...
        # Deleting field 'Source.filing'
        db.delete_column('lobbyingph_source', 'filing_id')
