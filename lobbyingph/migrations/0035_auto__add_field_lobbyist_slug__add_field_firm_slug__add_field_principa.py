...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Lobbyist.slug'
        db.add_column('lobbyingph_lobbyist', 'slug',
                      self.gf('django.db.models.fields.SlugField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Firm.slug'
        db.add_column('lobbyingph_firm', 'slug',
                      self.gf('django.db.models.fields.SlugField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Principal.slug'
        db.add_column('lobbyingph_principal', 'slug',
                      self.gf('django.db.models.fields.SlugField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Lobbyist.slug'
        db.delete_column('lobbyingph_lobbyist', 'slug')

        # Deleting field 'Firm.slug'
        db.delete_column('lobbyingph_firm', 'slug')

        # Deleting field 'Principal.slug'
        db.delete_column('lobbyingph_principal', 'slug')
    ...
    models = {
        ...
        'lobbyingph.article': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 12, 10, 0, 0)'}),
