...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Filing.errors'
        db.add_column('lobbyingph_filing', 'errors',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Filing.corrected'
        db.add_column('lobbyingph_filing', 'corrected',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Filing.errors'
        db.delete_column('lobbyingph_filing', 'errors')

        # Deleting field 'Filing.corrected'
        db.delete_column('lobbyingph_filing', 'corrected')
    ...
    models = {
        ...
        'lobbyingph.article': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 9, 4, 0, 0)'}),
