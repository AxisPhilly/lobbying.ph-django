...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Filing.total_exp_indriect_comm'
        db.delete_column('lobbyingph_filing', 'total_exp_indriect_comm')

        # Adding field 'Filing.total_exp_indirect_comm'
        db.add_column('lobbyingph_filing', 'total_exp_indirect_comm',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Filing.total_exp_indriect_comm'
        db.add_column('lobbyingph_filing', 'total_exp_indriect_comm',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True),
                      keep_default=False)

        # Deleting field 'Filing.total_exp_indirect_comm'
        db.delete_column('lobbyingph_filing', 'total_exp_indirect_comm')
    ...
    models = {
        ...
        'lobbyingph.filing': {
            ...
            'total_exp_indirect_comm': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
